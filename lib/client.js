...
`;
		...
		*/
		...
		function AccountQuota({ snapshot }) {
			...
			if (snapshot.error) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: accounts.map((candidate) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)(AccountQuota, { snapshot: accountUsage[candidate.id] }),
