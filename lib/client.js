...
`;
		...
		const zh = {
			...
			accountRoutingTitle: "账号数据面",
			accountRoutingScheduler: "多账号调度",
			accountRoutingNative: "原生直通",
			accountRoutingSchedulerHint: "启用账号池调度：依次用满／轮询、同一对话固定账号、失败前自动接力都会生效。",
			accountRoutingNativeHint: "只使用当前活动账号，完全绕过多账号调度器；用于测速和排障，不会自动轮询或接力。",
		...
		const en = {
			...
			accountRoutingTitle: "Account data path",
			accountRoutingScheduler: "Multi-account scheduler",
			accountRoutingNative: "Native direct",
			accountRoutingSchedulerHint: "Use the account-pool scheduler: fill-first / round-robin, session affinity, and pre-output failover are active.",
			accountRoutingNativeHint: "Use only the current active account and bypass the scheduler completely. Intended for speed A/B tests and diagnostics; no rotation or failover.",
...
`;
		...
		function createPreferenceController(scope, rpc) {
			...
			const read = () => {
				...
				return Object.freeze({
					...
					accountRoutingMode: normalizeAccountRoutingMode(value?.[ACCOUNT_ROUTING_MODE_FIELD]),
			...
			const acceptFallback = (value) => {
				...
				fallback = {
					...
					value: {
						...
						[ACCOUNT_ROUTING_MODE_FIELD]: normalizeAccountRoutingMode(value?.[ACCOUNT_ROUTING_MODE_FIELD]),
		...
		*/
		...
		function AccountRoutingPreference({ preference, t }) {
			...
			const choice = (value, label) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
					type: "radio",
					name: "codex-subscription-account-routing",
					checked: snapshot.accountRoutingMode === value,
					disabled: !writable,
					onChange: () => {
						preference.set({ [ACCOUNT_ROUTING_MODE_FIELD]: value });
					}
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: label })]
			});
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "codexSubscriptionPreferenceLabel",
						children: t("accountRoutingTitle")
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "codexSubscriptionPreferenceHint",
						children: t(snapshot.accountRoutingMode === "native" ? "accountRoutingNativeHint" : "accountRoutingSchedulerHint")
					})]
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "codexSubscriptionQuotaModes",
					...
					role: "radiogroup",
					"aria-label": t("accountRoutingTitle"),
					children: [choice(ACCOUNT_ROUTING_MODE_SCHEDULER, t("accountRoutingScheduler")), choice(ACCOUNT_ROUTING_MODE_NATIVE, t("accountRoutingNative"))]
				})]
			});
		}
		...
		function PreferencesCard({ preference, t, section = "display" }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [section === "advanced" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(AccountRoutingPreference, {
						preference,
						t
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "codexSubscriptionDivider" }),
		...
		function AccountCard({ rpc, t, account, setAccount, onSignedOut, preference }) {
			const preferenceSnapshot = usePreferenceSnapshot(preference);
			...
			const selectTestAccount = (id) => {
				setBusy(true);
				setError(void 0);
				call("account/test-select", { id }).then(setScheduler).catch((error) => setError(error instanceof Error ? error.message : t("failed"))).finally(() => setBusy(false));
			};
			...
			const updateScheduler = (patch) => {
				setBusy(true);
				setError(void 0);
				call("scheduler/update", patch).then(setScheduler).catch((error) => setError(error instanceof Error ? error.message : t("failed"))).finally(() => setBusy(false));
			};
			const importAccounts = (event) => {
				...
				(async () => {
					...
					setImportSummary(`已导入 ${added} 个账号，跳过 ${duplicates} 个重复账号${total === void 0 ? "" : `，当前共 ${total} 个`}`);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					signedIn ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "codexSubscriptionTestState",
						role: "status",
						"aria-live": "polite",
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: nativeDirect ? "当前链路：原生直通" : "当前链路：多账号调度" }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: ["速度：", fastMode ? "高速" : "标准"] }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
								nativeDirect ? "当前测试账号" : "当前活动账号",
								"：",
								activeAccountLabel
							] }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: nativeDirect ? "原生直通只使用当前测试账号，不会轮询或自动接力。" : "多账号调度会按下方策略选择账号。" })
						]
					}) : null,
					signedIn && scheduler !== void 0 && accounts.length > 1 && !nativeDirect ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "codexSubscriptionFlow",
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "codexSubscriptionActions",
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", { children: ["调度策略 ", /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
								disabled: busy,
					...
					signedIn && accounts.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: accounts.map((candidate) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							"data-active": nativeDirect ? candidate.id === testAccountId : candidate.active,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									nativeDirect ? candidate.id === testAccountId ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "codexSubscriptionAccountState",
										children: "当前测试账号"
									}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
										type: "button",
										variant: "primary",
										disabled: busy || loginVisible,
										onClick: () => selectTestAccount(candidate.id),
										children: "用此账号测试"
									}) : candidate.active ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "codexSubscriptionAccountState",
										children: "当前账号"
									}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
										type: "button",
