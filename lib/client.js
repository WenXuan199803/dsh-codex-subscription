		...
		*/
		...
		function AccountSchedulingControls({ candidate, busy, emailVisible, onConfigure }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", { children: ["优先级 ", /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
					type: "number",
					min: "-1000",
					max: "1000",
					step: "1",
				...
				children: [
					...
					signedIn && scheduler !== void 0 && accounts.length > 1 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							className: "codexSubscriptionPreferenceHint",
							children: "先选择优先级最高的已启用账号；同级账号再按所选策略调度。权重只用于加权轮询；同一对话固定账号时，轮询只影响新对话。"
						})]
					}) : null,
