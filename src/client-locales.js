export const zh = {
  ...
  usagePrevious: '上次成功的额度，可能已变化。', usagePreviousRefreshing: '正在刷新；下方保留上次成功的额度。', usagePreviousAfterError: '刷新失败；下方仍显示上次成功的额度。',
...
export const en = {
  ...
  usagePrevious: 'Last successful quota; it may have changed.', usagePreviousRefreshing: 'Refreshing; the last successful quota remains visible below.', usagePreviousAfterError: 'Refresh failed; the last successful quota remains visible below.',
